        ...
        <main className="container mx-auto max-w-7xl px-4 py-12">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-12">
            ...
            <article className="lg:col-span-2 space-y-8">
              ...
              {/* Section 2 */}
              <ContentSection id="o-que-e-importante" title={`O que é importante na hora de construir um plano de negócios para ${niche}?`}>
                <p>
              ...
              {/* Section 3 */}
              <ContentSection id="por-que-contratar" title={`Por que contratar uma consultoria para construir um plano de negócios para ${niche}?`}>
                <p>
